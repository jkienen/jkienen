...
| _`Task Manager`_ | _Full-stack task manager (FastAPI + SQLite + Next.js), fully containerized with Docker Compose and covered by automated API tests._ | [_Link_](https://github.com/jkienen/Challenge-TaskManager) |
