...
|---|---|
| [_Challenge TaskManager_](https://github.com/jkienen/Challenge-TaskManager) | _Full-stack task manager (FastAPI + SQLite + Next.js), fully containerized with Docker Compose and covered by automated API tests._ |
